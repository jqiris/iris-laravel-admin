...
XHEDITOR.setLang({
	...
	'Paste': '粘贴 (Ctrl+V)',
	'Pastetext': '粘贴文本',
	'PastetextTip': '使用键盘快捷键(Ctrl+V)把內容粘贴到方框里，按 确定',
	'Blocktag': '段落标签',
	'Fontface': '字体',
	'FontSize': '字体大小',
	'Bold': '加粗 (Ctrl+B)',
	...
	'upload': {
		...
		'typeLimit': '每次只能拖放上传同一類型文件',
		'apiError': '{$0} 上传接口发生错误！\r\n\r\n返回的错误內容为: \r\n\r\n{$1}'
	},

	'aboutXheditor': 'xhEditor是基于jQuery开发的跨平台轻量可视化XHTML编辑器，基于<a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>开源协议發布。'
});